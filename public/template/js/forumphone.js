...
app.controller('forumController', function ($scope, $http, $timeout, $location) {
    ...
    $scope.Toggle1 = function () {
        ...
        $('#forum1p').slideToggle();
        $('#forum2p').css('display', 'none');
        $('#forum3p').css('display', 'none');
        $('#forum4p').css('display', 'none');
    }
    $scope.Toggle2 = function () {

        $('#forum2p').slideToggle();
        $('#forum1p').css('display', 'none');
        $('#forum3p').css('display', 'none');
        $('#forum4p').css('display', 'none');
    }
